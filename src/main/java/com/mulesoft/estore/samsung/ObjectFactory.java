 ...
 * generated in the com.mulesoft.estore.samsung package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderResponse_QNAME = new QName("http://samsung.estore.mulesoft.com/", "orderResponse");
    private final static QName _Purchase_QNAME = new QName("http://samsung.estore.mulesoft.com/", "purchase");
    private final static QName _OrderRequest_QNAME = new QName("http://samsung.estore.mulesoft.com/", "orderRequest");
    private final static QName _PurchaseResponse_QNAME = new QName("http://samsung.estore.mulesoft.com/", "purchaseResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mulesoft.estore.samsung
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://samsung.estore.mulesoft.com/", name = "orderResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://samsung.estore.mulesoft.com/", name = "purchase")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://samsung.estore.mulesoft.com/", name = "orderRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://samsung.estore.mulesoft.com/", name = "purchaseResponse")
