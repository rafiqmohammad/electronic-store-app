...
@WebServiceClient(name = "SamsungServiceService", 
                  targetNamespace = "http://samsung.estore.mulesoft.com/") 
public class SamsungServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://samsung.estore.mulesoft.com/", "SamsungServiceService");
    public final static QName SamsungServicePort = new QName("http://samsung.estore.mulesoft.com/", "SamsungServicePort");
    static {
    	 URL url = null;
         try {
